  ...
  return (
    ...
    <div className="container z-10 px-4 mx-auto">
      ...
      <div className="flex justify-center">
        <a href="#about"
          className="transition duration-200 inline-block py-2 px-6 rounded-lg shadow ease-out font-bold bg-yellow-400 !text-noir hover:bg-yellow-400 ">Learn more</a>
      </div>
    </div>
  </section>
  )
